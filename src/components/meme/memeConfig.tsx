...
const LONK_CONFIG = {
  ...
  body: (initWidth: any, addWidth: any, percent: any) => {
    ...
    return (
      <div className="flex justify-center relative">
        ...
        <span className="absolute lg:top-2 xsm:top-1.5 lg:text-xl xsm:text-sm text-white paceGrotesk-Bold z-10">
          {percent || ""}
        </span>
      </div>
    );
  ...
  body: (initWidth: any, addWidth: any, percent: any) => {
    ...
    return (
      <div className="flex justify-center relative">
        ...
        <span className="absolute lg:top-4 xsm:top-3 lg:text-xl xsm:text-sm text-black paceGrotesk-Bold z-10">
          {percent || ""}
        </span>
      </div>
    );
  ...
  body: (initWidth: any, addWidth: any, percent: any) => {
    ...
    return (
      <div className="flex justify-center relative">
        ...
        <span className="absolute lg:top-1 xsm:top-0.5 lg:text-xl xsm:text-sm xsm:-ml-2 text-white paceGrotesk-Bold z-10">
          {percent || ""}
        </span>
      </div>
    );
  ...
  body: (initWidth: any, addWidth: any, percent: any) => {
    ...
    return (
      <div className="flex justify-center relative">
        ...
        <span className="absolute lg:top-6 xsm:top-4 lg:text-xl xsm:text-sm xsm:-ml-4 text-black paceGrotesk-Bold z-10 transform translate-x-4">
          {percent || ""}
        </span>
      </div>
    );
